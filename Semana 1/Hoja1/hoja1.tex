...
\begin{center}
        ...
        \large{Fecha de entrega: 25 de Enero, 2018} \\
        \horrule{1pt}
\end{center}
...
Descargar e instalar el framework \emph{.Net Core} desde \url{https://www.microsoft.com/net/learn/get-started/windows}
